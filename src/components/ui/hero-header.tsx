...
export const HeroHeader = () => {
  ...
  return (
    ...
    >
      <div id="header" className="relative h-screen w-full bg-black flex flex-col items-center justify-center overflow-hidden rounded-md mb-[5vh]">
        <ParticleLinks className="absolute w-full h-full"/>
        <h1 id="main_page" className="text-3xl sm:text-5xl md:text-7xl lg:text-9xl font-light text-center text-white relative mx-auto w-full z-20 pt-[5rem]">
          Architech Solutions
        </h1>
