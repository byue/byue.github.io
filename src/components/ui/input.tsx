      ...
      <div>
        ...
        >
          <Field
            ...
            type={type}
            className={cn(
              `flex-none w-full border-none bg-zinc-800 font-light text-white shadow-input rounded-md px-3 text-sm file:border-0 file:bg-transparent 
        ...
        <ErrorMessage name={name!} render={msg => <div className="font-light text-sm text-red-500">{msg}</div>}/>
      </div>
    );
  }
);
